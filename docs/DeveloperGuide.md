...
Any.do | <ul>  <li>Any.do Moment show tasks due TODAY </li> <li>Any.do Moment allowly reschedule, marking as done or delete </li>  <li> Allow user to set reminder </li> <li>Allow user to add sub-task to a bigger Task </li> <li>User can see what due today/tomorrow or upcoming </li></ul>  | <ul> <li>Cant block a time </li>  <li>Require internet for syncing of data </li>  <li> free user cant customized recurring tasks</li>  <li> free user cant access Any.do Moment</li>  <li>Require monthly/yearly subscription for premium services  </li><li>Require alot of clicking</li> </ul> 
