...
Any.do | <ul>  <li>Any.do Moment show tasks due TODAY </li> <li>Any.do Moment allowly reschedule, marking as done or delete </li>  <li> Allow user to set reminder </li> </ul>  | <ul> <li>Cant block a time </li>  <li>Require internet for syncing of data </li>  <li> free user cant customized rcurring tasks</li>  <li> free user cant access Any.do Moment</li>  <li>Require monthly/yearly subscription for premium services  </li><li>Require alot of clicking</li> </ul> 
