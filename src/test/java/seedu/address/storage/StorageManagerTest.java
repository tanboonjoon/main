...
public class StorageManagerTest {
    ...
    public void taskForceReadSave() throws Exception {
        ...
        // More extensive testing of TaskForce saving/reading is done in
        // XmlTaskForceStorageTest
    }
    ...
    public void handleTaskForceChangedEvent_exceptionThrown_eventRaised() throws IOException {
        ...
        Storage storage = new StorageManager(new XmlTaskForceStorageExceptionThrowingStub("dummy"),
