Testcase ID: TC001
Title : Loading Sample test data
Description : Tester should be able to load the sample data successfully
Assumption : Tester yet to open the app once
...
5 | Transfer the forDemoUse.xml in  'ManualTesting' folder and overwrite the forDemoUse file in
'taskForceTest' | the forDemoUse.xml in 'taskForceTest' should be overwritten by the one in 'ManualTeting folder'
