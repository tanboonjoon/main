...
public class MainApp extends Application {
    ...
    public static final Version VERSION = new Version(0, 0, 3, false);
    ...
    private Model initModelManager(Storage storage, UserPrefs userPrefs, Config config) {
        ...
        try {
            ...
            logger.warning("Problem while reading from the file. . Will be starting with an empty TaskForce");
            initialData = new TaskForce();
        }
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting TaskForce " + MainApp.VERSION);
        ui.start(primaryStage);
    }

    @Override
    public void stop() {
        logger.info("============================ [ Stopping TaskForce ] =============================");
        ui.stop();
        try {
