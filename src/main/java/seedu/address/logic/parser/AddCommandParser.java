...
public class AddCommandParser extends CommandParser {
    ...
    public Command prepareCommand(String args) {
        ...
        try {
            ...
            return new AddCommand(
                    ...
                    AddCommandParser.<String>getArgValueFromOptional(parser.getArgValue(CommandArgs.START_DATETIME),
                            null),
                    AddCommandParser.<String>getArgValueFromOptional(parser.getArgValue(CommandArgs.END_DATETIME),
                            null),
    ...
    private ArgumentsParser prepareParser(ArgumentsParser parser) {
        ...
        parser.addNoFlagArg(CommandArgs.NAME).addOptionalArg(CommandArgs.DESC).addOptionalArg(CommandArgs.TAGS)
                .addOptionalArg(CommandArgs.START_DATETIME).addOptionalArg(CommandArgs.END_DATETIME)
                .addOptionalArg(CommandArgs.RECURRING).addOptionalArg(CommandArgs.REPETITION);
        return parser;
    }
